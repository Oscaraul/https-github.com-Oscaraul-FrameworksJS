...
$(function(){
  ...
  $("#btn-vaca").click(function(){
    cursorNormal();
    $("#vaca").toggle(2000,'linear',function(){
      $("#mensaje").show();
  ...
  $("#btn-cerdo").click(function(){
    cursorNormal();
    $("#cerdo").toggle(2000,'linear',function(){
      $("#mensaje").show();
  ...
  $("#btn-gallina").click(function(){
    cursorNormal();
    $("#gallina").toggle(2000,'linear',function(){
      $("#mensaje").show();
  ...
  $("#btn-oveja").click(function(){
    cursorNormal();
    $("#oveja").toggle(2000,'linear',function(){
      $("#mensaje").show();
